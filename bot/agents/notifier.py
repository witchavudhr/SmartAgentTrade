...
async def cmd_ob(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        msg = (
            ...
            f"*BSL* 🔵 (เหนือราคา):\n{w_bsl_lines}\n\n"
            f"*SSL* 🟠 (ใต้ราคา):\n{w_ssl_lines}\n"
            f"_★=major(EQH/EQL) ·=minor | M15=stronger | ✕ขีดฆ่า=swept แล้ว (โชว์ไว้อ้างอิง ไม่ใช่ pool ที่ยังใช้ได้)_\n\n"
            f"━━━━━━━━━━━━━━━━━\n"
...
def run():
    ...
    # bar_cache cleanup — ลบแท่งเก่าเกิน 60 วัน จันทร์-ศุกร์ 04:00 Thai
    # (ไม่ต้องรันเสาร์-อาทิตย์ เพราะตลาดปิด ไม่มีข้อมูลใหม่ให้เก็บกวาด)
    ...
    app.job_queue.run_daily(
        ...
        days=(0, 1, 2, 3, 4),  # จันทร์-ศุกร์ เท่านั้น
    )
